...
router.get('/appointments', logActivity('Viewed all appointments'), getAllAppointments);
router.put('/user', logActivity('Updated a user'), updateUser);
router.delete('/user/:userId', logActivity('Deleted a user'), deleteUser);
router.put('/appointment', logActivity('Updated an appointment'), updateAppointment);
router.delete('/appointment/:appointmentId', logActivity('Deleted an appointment'), deleteAppointment);
